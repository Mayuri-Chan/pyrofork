...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    async def func(flt, client: pyrofork.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyrofork.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyrofork.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyrofork.types.InlineQuery`: The filter will match ``query``.
